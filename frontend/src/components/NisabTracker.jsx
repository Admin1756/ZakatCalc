...
export default function NisabTracker({ currency, setCurrency, prices, setPrices }) {
    ...
    <div className="relative bg-gradient-to-br from-emerald-50/80 via-white to-amber-50/40 border border-emerald-900/10 rounded-2xl p-5 md:p-6">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <div className="text-xs text-emerald-900/60 mt-0.5">Prices indicative. Edit to match your bank/market rates.</div>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-[11px] text-emerald-900/60">{GOLD_NISAB_GRAMS}g · 24K</div>
              </div>
            </div>
            {editing ? (
              <input
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-[11px] text-emerald-900/60">{SILVER_NISAB_GRAMS}g · 999</div>
              </div>
            </div>
            {editing ? (
              <input
      ...
      <div className="mt-4 flex items-center justify-between text-xs text-emerald-900/65">
        <div className="flex items-center gap-1.5"><TrendingUp className="w-3.5 h-3.5" /> Zakat rate <span className="font-bold text-emerald-900">2.5%</span> on net wealth above Nisab</div>
        {editing && (
